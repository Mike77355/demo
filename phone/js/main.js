...
$(function() {
    function set_subNav() {
        if (matchMedia("screen and (max-width:768px)").matches) {
            ...
            $(".navDom li.level-1").each(function(index, element) {
            ...
            $(".navDom li.level-1").each(function(index, element) {
                ...
                $(this).hover(function() {
                    ...
                    $("ul.nav>li.level-1").removeClass("active-nav");
    ...
    $(".btn-navSwitch").click(function() {
        $(this).toggleClass("openNav");
        if (parseInt($(".navDom").width()) == set_width) {
            $(".navDom").fadeOut(200).animate({
                "width": "0px"
            }, 200);
            $(".maskBox").slideUp(100);

            $(".subNav").slideUp(200);
            $("li.level-1").removeClass("active-nav");
        } else {
            $(".navDom").fadeIn(10).animate({
                "width": set_width + "px"
            }, 300);
            $(".maskBox").fadeIn(400);
    ...
    $(".right-content .article-content>p>a>img").each(function(index, element) {
        $(this).parent("a").attr("href", "javascript:void(0);").removeAttr("target").css("cursor", "default");
    });
